...
function TransactionsTable({ transactions, addTransaction, setTransactions }) {
  ...
  const handleDelete = async (id) => {
    console.log("handled Delete Call key is -------------------> ", id);
    try {
  ...
  const columns = [
    ...
    { title: "Date", dataIndex: "date", key: "date" },
    {
      ...
      key: "action",
      render: (_, record) => (
        <Button text={"Delete"} onClick={() => handleDelete(record.id)} />
      ),
    },
  ];
